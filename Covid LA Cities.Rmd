...
This document is mainly for scratch and testing. For the actual data with graphs and errors, look at the "Shiny Covid LA Cities.Rmd" file
...
city_pred_error = function(city) {
  ...
  errors_table = cbind(sev_reg, n_sev_reg)
  return(errors_table)
}
```
